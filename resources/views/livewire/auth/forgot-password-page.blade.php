            ...
            <div class="mt-5">
              ...
              <form wire:submit='save'>
                ...
                <div class="grid gap-y-4">
                    ...
                    <div class="relative">
                      ...
                      @error('email')
                        <div class="absolute inset-y-0 end-0 flex items-center pointer-events-none pe-3">
                            ...
                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0
                            0-2z" />
                            </svg>
                        </div>
                      @enderror
                  ...
                  hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none
                  dark:focus:ring-1 dark:focus:ring-gray-600">Restablecer la contraseña</button>
                </div>
              </form>
              <!-- End Form -->
            </div>
