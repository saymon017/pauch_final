            ...
            <div class="lg:pl-20">
              ...
              <div class="w-32 mb-8 ">
                ...
                <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                  ...
                  <input type="number" wire:model.live='quantity' readonly class="flex items-center w-full font-semibold text-center text-gray-700 placeholder-gray-700 bg-gray-300 outline-none dark:text-gray-400 dark:placeholder-gray-400 dark:bg-gray-900 focus:outline-none text-md hover:text-black" placeholder="1">
